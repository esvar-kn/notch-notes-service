...
// Proxy rule for Auth Service (port 4001) using pathFilter so Express does not strip url prefix
...
// Proxy rule for Notes Service (port 4002) using pathFilter
...
const server = app.listen(PORT, '0.0.0.0', () => {
    ...
    console.log(`   Routing /api/v1/notes               -> ${NOTES_SERVICE_URL}`);
});
